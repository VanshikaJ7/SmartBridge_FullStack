                ...
                <div className="createPostBody">
                    ...
                    <select className="form-select" aria-label="Select Post Type" onChange={(e)=> setStoryType(e.target.value)}  >
                        ...
                        <div className="uploadBox">
                            <input type="file" name="PostFile" id="uploadStoryFile" onChange={(e)=> setStoryFile(e.target.files[0])} />
                        </div>
                        <div className="form-floating mb-3 authFormInputs descriptionInput">
                            <input type="text" className="form-control descriptionInput" id="floatingStoryDescription" placeholder="Description" 
                        ...
                        :
                        <button onClick={handleStoryUpload}>Upload here </button>
                        }
                    </form>
                </div>
            </div>
